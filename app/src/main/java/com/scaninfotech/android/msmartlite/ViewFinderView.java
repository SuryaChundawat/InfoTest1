...
import com.scaninfotech.android.msmartlite.DisplayUtils;
...
public class ViewFinderView extends View {
    ...
    public void drawViewFinderMask(Canvas canvas) {
        ...
        paint.setColor(resources.getColor(me.dm7.barcodescanner.core.R.color.viewfinder_mask));
    ...
    public void drawViewFinderBorder(Canvas canvas) {
        Paint paint = new Paint();
        Resources resources = getResources();
        paint.setColor(resources.getColor(me.dm7.barcodescanner.core.R.color.viewfinder_border));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(resources.getInteger(me.dm7.barcodescanner.core.R.integer.viewfinder_border_width));
        int lineLength = resources.getInteger(me.dm7.barcodescanner.core.R.integer.viewfinder_border_length);
    ...
    public void drawLaser(Canvas canvas)
    {
        ...
        paint.setColor(resources.getColor(me.dm7.barcodescanner.core.R.color.viewfinder_laser));
